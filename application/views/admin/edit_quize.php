                      ...
                      <form role="form" method="post"  name="add_quize" id="add_quize">      
                            <div class="form-group">
                                <label>Course Name</label>
                                    <input type ="text" value="<?php echo ucfirst($question_info['courses_name']);?>" readonly>
                            </div>
                         
                             <div class="form-group" id="ans_opt_div">
                                <label>Selected Answer Type</label>
                                   <input type ="text" value="<?php if($question_info['type']==2){ echo 'True/False';}else { echo 'MCQ';} ?>" readonly>
                            ...
                            <div class="form-group" id="question_div">
                                ...
                                <input type="text" id="quize_ques" name="quize_ques" class="form-control required" value="<?php echo $question_info['question'];?>">    
                            </div>
                            <div class="form-group" id="question_div">
                                <label>Currect Answer</label>
                                <input type="text" id="curr_answer" name="curr_answer" class="form-control required" value="<?php echo $question_info['correct_answer'];?>" readonly>    
                            </div>
                                

                                <div class="form-group" id="select_new_option" >
                                <label>Change Previous options</label>
                                    <select id="change_prev_op"  class="form-control required">
                            ...
                            <?php $listOptions=FngetOptions($question_info['qid']);?>
                            <div class="form-group" id="select_option_div1" style="display:none;">
                                <label>Change Currect Answer</label>
                                    <select id="change_curr_op" name="change_curr_op" class="form-control required">
                                        <option value="">--Select--</option>
                                        <?php foreach($listOptions as $options):?>
                                        <option value="<?php echo $options['option'];?>" <?php if($options['option']==$question_info['correct_answer']){ echo 'Selected';} ?>><?php echo $options['option'];?></option>
                            ...
                            <div class="form-group" id="statement_div">
                             ...
                             <div class="form-group" id="true_false_div">
                                <label>Change Answer</label><br>
                                     <input type="radio" name="true_false" value="True" class="required" <?php if($question_info['correct_answer']=='True'){ echo 'checked';}?>> True<br>
                                     <input type="radio" name="true_false" value="False" class="required" <?php if($question_info['correct_answer']=='False'){ echo 'checked';}?>> False<br>
                           ...
                           <input type="submit" name="edit_quiz" value="Edit Quiz" class="btn btn-primary">
