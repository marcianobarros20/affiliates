                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><?php echo date('d/m/Y',strtotime($blog['add_date']));?></td>
                      <td><?php if($blog['status']==0){echo 'Active';} else { echo 'Inactive';}?></td>
                      
                     <td><span class="label label-danger" onclick="change_status('Delete','<?php echo $blog['blog_id'];?>')">Delete</span>
                     <?php if($blog['status']==0):?>
                     <span class="label label-danger" onclick="change_status('Inactive','<?php echo $blog['blog_id'];?>')">Inactive</span>
                     <?php endif;?>
                     </td>
