   ...
   <?php echo $header;?>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Affiliates Payouts</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="about-us" class="container main">
        <div class="row-fluid">
            <div class="span6">
                ...
                <ul>
                    ...
                    <li>C = Tier5 Cost</li>
                    <li>P = Payout</li>
                    <li><strong>P = SP - C</strong></li>
                 </ul>
                 <p>In the worst case scenario 50% of the payout is yours, in the best case 100% is yours.  Your % of the payout depends on how many Tiers are above you. As you can guess Tier5 has 5 Tiers (although that is not the reason behind our name). </p>
            </div>
            <div class="span6">
                <h2>Payouts</h2>
                <div>
                    <div class="progress progress-success "><div class="bar" style="width: 100%; text-align:left; padding-left:10px;">Tier[5] 50% - 100%</div></div>
                    <div class="progress "><div class="bar" style="width: 60%; text-align:left; padding-left:10px;">Tier[4] 15%</div></div>
                    <div class="progress progress-info"><div class="bar" style="width: 40%; text-align:left; padding-left:10px;">Tier[3] 10%</div></div>
                    <div class="progress progress-info"><div class="bar" style="width: 40%; text-align:left; padding-left:10px;">Tier[2] 10%</div></div>
                    <div class="progress progress-info"><div class="bar" style="width: 40%; text-align:left; padding-left:10px;">Tier[1] 10%</div></div>
                    <div class="progress progress-warning"><div class="bar" style="width: 20%; text-align:left; padding-left:10px;">Tier[0] 5%</div></div>
                </div>
            </div>
        </div>
        ...
        <div class="row-fluid text-center">
            ...
            <div class="span3">
                <div class="box">
                    <p><img src="images/sample/tier0.jpg" alt="" ></p>
                    <h5>Julie -- Tier[5]</h5>
                    <h3>Mark recurited Julie</h3>
                    <p>Congratulations, your down stream is now full. Just remember you can have various Tier[4]'s to Tier[0]'s. You can recruit as many people as you want, and so can they. Julie came in at Tier[5] but she is your Tier[0]. You get 5% of all Amy's sales.</p>
        ...
        <div class="row-fluid">
            <div class="span6">
                ...
                <li>Tier[2]: 10% of payout</li>
                <li>Tier[1]: 10% of payout</li>
                <li>Tier[0]: 5% of payout</li>
                </ul>
            </div>
            <div class="span6">
                ...
                <div class="accordion" id="accordion2">
                  ...
                  <div id="collapseOne" class="accordion-body collapse">
                    <div class="accordion-inner">
                      You are a Tier[x] of no one, you are at the Top Tier, this means you started with Tier5 from the beginning. Let’s say our minimum cost is $15/hr and you contract 1 hour for $25/hr. You would get 100% of (25-15), or you would get $10 paid out to you. 
                  </div>
              </div>
          </div>
          <div class="accordion-group">
  ...
  <div class="accordion-group">
      <div class="accordion-heading">
        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
          Realistic Example with your down stream.
      </a>
  </div>
