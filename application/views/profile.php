            ...
            <div class="row-fluid">
                <div class="span8">
                  <div class="row-fluid">
                    ...
                    <div class="span8 personal-info">
                        ...
                        <div class="description-block">
                          <h5>Email:</h5>
                          <p><?php echo $fetch_allinfo['email']?></p>  
                        </div> 
                        <div class="description-block">  
                          <h5>Refferal Code:</h5>
                          <p><?php echo $fetch_allinfo['refferalcode'];?></p>  
                        </div>
                        <div class="description-block">
                          <h5></h5>
                          <p><a class="edit-btn" href="<?php echo base_url();?>Welcome/editprofile">Edit Profile</a></p>  
                        </div> 
                    </div>
                  </div>
                </div>
                <div class="span4">
                  <div class="link-section">
                    <h5>To Affiliate People, Please forword the below link.</h5>
                    <br>
