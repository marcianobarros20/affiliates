        ...
        <div class="row-fluid">
            ...
            <div class="span3">
                ...
                <ul class="unstyled address">
                    <li>
                        <i class="icon-home"></i><strong>Address:</strong> 2789 N Newman Rd, Lexington IN,<br> 47138
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <strong>Website:</strong> http://www.tier5.us 
                    </li>
                    <li>
            ...
            <div id="tweets" class="span3">
                ...
                <div>
                    <ul class="arrow">
                        <li><a href="<?php echo base_url();?>index.php/Contents/about_us">About Us</a></li>
                        ...
                        <li><a href="<?php echo base_url();?>index.php/Contents/blog">Blog</a></li>
                    </ul>
                </div>  
            </div>
            <!--Important Links-->
