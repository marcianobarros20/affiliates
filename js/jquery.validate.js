...
$.extend($.validator, {
	...
	messages: {
		...
		email_id: "Enter only letters, numbers and underscore",
		...
		mustMin: $.validator.format("Please enter a value greater than {0}."),
	...
	methods: {
        ...
        mustMin: function( value, element, param ) {
		var target = $(param);
			if (this.settings.onfocusout) {
				target.unbind(".validate-mustMin").bind("blur.validate-mustMin", function() {
					$(element).valid();
				});
			}
			return parseInt(value) > parseInt(target.val());
		},
		emptyValue: function(value, element,param) {
			return this.optional(element) || value!=param;
		},
